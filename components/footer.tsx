        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">{siteConfig.company.name}</span>
            </div>
            <p className="text-gray-300 mb-4 leading-relaxed">{siteConfig.company.description}</p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start space-x-3">
              ...
              <span className="text-gray-300">{siteConfig.contact.address.fulladdress}</span>
            </div>
            <div className="flex items-center justify-center md:justify-start space-x-3">
