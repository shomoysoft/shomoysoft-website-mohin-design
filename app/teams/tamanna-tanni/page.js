...
import member from "@/data/team/tamanna-tanni";
...
export default function TanniPortfolioPage() {
            ...
            <Card>
              ...
              <CardContent>
                <div className="relative">
                  ...
                  <div className="absolute left-[15px] top-0 bottom-0 w-0.5 bg-blue-600"></div>
